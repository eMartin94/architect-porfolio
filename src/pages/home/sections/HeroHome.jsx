...
const HeroHome = ({ lang }) => {
  ...
  return (
    <div className='flex flex-col justify-center bg-gradient-hero bg-cover bg-fixed h-screen items-center'>
      <div className='flex flex-col md:flex-row gap-4 w-full max-w-7xl justify-center items-center px-10'>
        <div className='md:text-left text-center'>
          <h1 className={`txt-shadow ${styles.title}`}>carla melany</h1>
          <p className='text-3xl pl-2 mt-5 md:mt-2'>{description}</p>
          <p className='w-full md:w-[60%] mt-10 pl-2'>
            <span>{quote}</span> - {author}
          </p>
        </div>
        <div className='blocks-shadow hidden sm:flex w-[200px] md:w-[450px] bg-secondary justify-center items-center overflow-hidden'>
